			...
			return "
				<nav class='z-depth-1 nav-fixed' role='navigation'>
					...
					<ul id='userMenu' class='dropdown-content'>
						<li><a href='../conta/index.php' class='black-text'><i class='material-icons'>person</i>VER INFORMAÇÕES</a></li>
					...
					<ul id='nav-mobile' class='side-nav' style='left: 0px;'>
						...
						<li><a href='../conta/index.php' class='white-text'><i class='material-icons white-text'>person</i>VER INFORMAÇÕES</a></li>
